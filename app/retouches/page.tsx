                ...
                <div className="contact-res-container">
                    <div className="contact-res-header">
                        ...
                        <p className="contact-res-sub">
                            Ce calendrier privé vous permet de convenir de votre créneau d&apos;ajustement.
                            Merci de consulter les recommandations ci-dessous avant de choisir votre horaire.
                        </p>
                    </div>
                    ...
                    <div className="contact-info-col">
                        ...
                        <div className="cd" style={{ "--ci": 1 } as React.CSSProperties}>
                            ...
                            <div className="cdt">
                                ...
                                <span>
                                    Le soutien-gorge, les coques invisibles et sous-vêtements prévus afin de calibrer le décolleté et le maintien du bustier.
                                </span>
                            </div>
                        </div>
