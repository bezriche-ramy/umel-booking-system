...
export default function ContactPage() {
    ...
    return (
        <>
            ...
            <section className="s res-page-section" id="reservation">
                <div className="contact-res-container">
                    <div className="contact-res-header">
                        <span className="sl-lbl">Réservation Privée</span>
                        ...
                        <p className="contact-res-sub">
                            Sélectionnez votre prestation, votre créneau et vos disponibilités pour débuter votre accompagnement couture.
                        </p>
                    </div>
            ...
            <section className="s contact-atelier-section">
                <div className="contact-atelier-grid">
                    <div className="contact-info-col">
                        <span className="sl-lbl">Nous Trouver</span>
                        ...
                        <div className="cd" style={{ "--ci": 0 } as React.CSSProperties}>
                            <div className="cdi" aria-hidden="true">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--or)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <div className="cdt">
                                ...
                                <span>
                                    ...
                                    <br />
                                    <em style={{ fontSize: "13px", color: "var(--taupe)" }}>Stationnement aisé devant la maison</em>
                                </span>
                            </div>
                        </div>
                    ...
                    <div className="contact-map-col">
                        <span className="sl-lbl">Plan d&apos;accès</span>
            ...
            {/* CTA WHATSAPP DIRECT */}
            <section className="s contact-whatsapp-section">
                <div className="contact-whatsapp-box">
                    <span className="sl-lbl">Contact direct</span>
                    <h2 className="contact-whatsapp-title">
                        Vous préférez nous écrire
                        <br />
                        <em>directement ?</em>
                    </h2>
                    <p className="contact-whatsapp-sub">
                        Envoyez-nous un message ou une vidéo portée via WhatsApp pour une première estimation rapide ou pour toute question.
                    </p>
                    <a
                        href={siteConfig.whatsappUrl}
                        target="_blank"
