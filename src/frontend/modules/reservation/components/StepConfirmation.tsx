...
import { formatFrenchLongDate, generateICSContent } from "@frontend/modules/reservation/lib/date-utils";
import { ReservationConfirmation } from "@shared/reservation/types";
